 ...
 */
export function createStringDelta(source: string, target: string): string {
	const deltaArray = createDelta(
 ...
 */
export function applyStringDelta(
	source: string,
	delta: string,
	opts?: Options
): string {
	const deltaArray = applyDelta(
		new TextEncoder().encode(source),
 ...
 */
export function getStringDeltaTargetSize(delta: string): number {
